...
class AccountAdmin(MPTTModelAdmin):
    ...
    list_currencies.short_description = "Currencies"
    ...
    list_filter = ["type", "active", "net_worth", "dashboard", "currencies"]
    search_fields = ["name", "uuid", "iban"]
    fieldsets = [
        ["General information", {"fields": ["name", "parent", "iban", "slug", "type", "icon", "currencies"]}],
        ["Options", {"fields": ["active", "net_worth", "dashboard", "uuid"]}],
    ]
...
class TransactionAdmin(admin.ModelAdmin):
    ordering = ["date"]
    date_hierarchy = "date"
    list_display = ["uuid", "short_description", "payee", "date", "created", "modified"]
    search_fields = ["short_description", "uuid", "payee", "description"]
    list_filter = ["payee"]
    fieldsets = [
        ["General information", {"fields": ["date", "short_description", "payee", "description", "category"]}],
        ["Options", {"fields": ["uuid"]}],
    ]
